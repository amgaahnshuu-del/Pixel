...
const frag = /* glsl */ `
  ...
  const vec3 baseColor1 = vec3(1.000000, 0.302000, 0.741000);
  const vec3 baseColor2 = vec3(1.000000, 0.553000, 0.871000);
  const vec3 baseColor3 = vec3(0.520000, 0.070000, 0.360000);
